...
export default function ToddLauncher() {
  return (
    <Link
      ...
      className="fixed z-40 right-4 bottom-[calc(72px+env(safe-area-inset-bottom))] w-14 h-14 rounded-full overflow-hidden shadow-lg shadow-black/40 ring-2 ring-[#0082FF]/60 hover:brightness-110 transition"
    >
